                                    ...
                                    <div class="contain-product layout-default">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="slide-down-box">
                                                <div class="buttons">
                                                    <a class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                    <a href="{{ route('product.details',$product->id) }}" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Order Now</a>
                                                    <a class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
