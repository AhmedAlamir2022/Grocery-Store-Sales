        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Add General Offer</li>
                </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> Add General Offer</h4>
                    <form class="form-sample" action="{{ route('estore.offer') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        @csrf
